...
class S3Utils:
    ...
    def upload_file(
        self, file_path: str, s3_key: str, extra_args: Optional[dict] = None
    ) -> bool:
        """
        ...
        try:
            self.s3.upload_file(
                file_path, self.bucket_name, s3_key, ExtraArgs=extra_args or {}
            )
            return True
    ...
    def upload_json(
        self, data: Any, s3_key: str, extra_args: Optional[dict] = None
    ) -> bool:
        """
